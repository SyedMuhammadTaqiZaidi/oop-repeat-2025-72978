...
namespace WorkshopSystem.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedMechanicId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceRecords_AspNetUsers_AssignedMechanicId",
                        column: x => x.AssignedMechanicId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRecords_AspNetUsers_RequestedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRecords_AssignedMechanicId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRecords_RequestedById",
                table: "ServiceRecords",
